...
def main():
    ...
    # Display a final confirmation to the screen, and append the same
    # message to the results file so anyone reviewing the log file later
    # can see the run finished (rather than being cut off mid-way).
    print("Task Completed ")
    log_to_file("Run Status", "Task Completed ")
