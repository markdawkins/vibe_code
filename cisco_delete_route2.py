#!/usr/bin/env python3
"""
cisco_delete_route2.py

Connects to a Cisco IOS router over SSH and REMOVES an existing static
route, verifies it was removed, saves the configuration, and displays
confirmation output.
...
def get_inputs():
    """Prompt the user for all required connection and route details."""
...
def main():
    # Gather connection info and the route that should be deleted
    data = get_inputs()
    ...
    try:
        ...
        # it still exists in the config after the delete attempt.
        ...
        # Simple confirmation that the workflow has finished
        print("\nTask Complete")
