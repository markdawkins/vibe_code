...
class StudyTracker:
    ...
    def setup_gui(self):
        ...
        for idx, subject in enumerate(self.subjects, start=1):
            ...
            # Study Task Details entry (renamed from Task Name)
            task_entry = tk.Entry(scrollable_frame, width=25, font=("Arial", 10))
            ...
            # Target Reached combobox (new field)
            ...
            # Study Hours combobox (new field)
            ...
            comments_frame.grid(row=idx, column=5, sticky="nsew", padx=2, pady=2)
            
            comments_text = tk.Text(comments_frame, height=3, width=25, font=("Arial", 9))
        ...
        scrollable_frame.grid_columnconfigure(5, weight=2)
        ...
        try:
            ...
            with open(filename, 'a', newline='', encoding='utf-8') as csvfile:
                fieldnames = ['Date', 'Subject', 'Study_Task_Details', 'Status', 
                             'Target_Reached', 'Study_Hours', 'Comments']
    ...
    def clear_all(self):
        ...
        for subject in self.subjects:
            ...
            entries['target_combo'].set(self.target_options[1])  # Default "No"
            entries['hours_combo'].set(self.hours_options[0])    # Default "1 hour"
    ...
    def show_summary(self):
        ...
        tk.Label(summary_window, text="=" * 30, font=("Arial", 10)).pack()
        ...
        if total_tasks > 0:
            ...
            tk.Label(summary_window, text=f"Completion Rate: {completion_rate:.1f}%", 
                    font=("Arial", 11)).pack(pady=5)
        ...
        for subject in self.subjects:
            ...
            if subject_data:
                ...
                info = f"{subject}: {task_detail[:30]}... - {status} - Target: {target} - {hours}"
                tk.Label(scrollable_frame, text=info, font=("Arial", 9), 
                        wraplength=350, justify=tk.LEFT).pack(pady=2, anchor=tk.W)
